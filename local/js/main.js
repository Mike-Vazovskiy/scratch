...
$(function(){
	...
	var container    = document.getElementById('main__cards_item'),
		 canvas       = document.getElementById('main__cards_item--canvas1'),
	...
	var innterval = setInterval(function() {
		...
		count++;
		$(".modal .modal__bigText span").text(count);
	}, 0);
	...
	function handlePercentage(filledInPixels,scratched) {
		...
		setTimeout(function(){
		 $('.modal').removeClass('hidden');
		 $(".modal .modal__bigText span").text('400');
		}, 14400)
	 }
